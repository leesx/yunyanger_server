                ...
                case 'String':
                    {
                        let list_cover_name = urls
                            ...
                            .split('/')
                            .pop();
                        let fileName = await uploadToQiniu(urls, 'yunyangriji', list_cover_name);
                ...
                case 'Array':
                    {
                        ...
                        for (let i = 0; i < urls.length; i++) {
                            let qiniu_key = await uploadToQiniu(urls[i], 'yunyangriji', list_cover_name[i]);
        ...
        return new Promise((resolve, reject) => {
            switch (type) {
                case 'lists':
                    {
                        axios
                            .post(`http://52.8.245.233:${server_port}${query}`, data)
                            .then((res) => {
                                resolve(res.data);
                            })
                    }
